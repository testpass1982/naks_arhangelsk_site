"""
Django settings for naks_arhangelsk_site project.
...
SECRET_KEY = 'x-uk$+yb93o*p*=3xic%p0zp5slprn8u)i@d((%3ltr=#$tjf!'
...
ROOT_URLCONF = 'naks_arhangelsk_site.urls'
...
WSGI_APPLICATION = 'naks_arhangelsk_site.wsgi.application'
