# Generated by Django 2.1.2 on 2019-02-06 06:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('menu_link', models.CharField(choices=[('ATTSP', 'Аттестация специалистов сварочного производства'), ('ATTSV', 'Аттестация сварщиков'), ('ATTSO', 'Аттестация сварочного оборудования'), ('ATTST', 'Аттестация технологий сварки'), ('ATTAP2', 'Аттестация в АП2'), ('OKSV', 'Оценка квалификаций')], default='NONE', max_length=100)),
